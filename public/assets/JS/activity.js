document.getElementById('activityAdd').addEventListener('click', event => {
  ...
  axios.post('/api/activities/', {
    ...
    .then(({ data }) => {
      ...
      activityElem.id =`activity-${data.id}`
    ...
    <div class="card-body">
      ...
      <div class="cardActions d-flex justify-content-between">
        ...
        <svg class="bi bi-pencil-square" onclick="editActivity()" data-id=${data.id} width="1.3em" height="1.3em" viewBox="0 0 16 16" fill="currentColor"
          xmlns="http://www.w3.org/2000/svg">
          <path
